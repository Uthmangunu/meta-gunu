...
- Raw microphone audio is streamed in memory and not written to disk.
...
The product does not claim access to ChatGPT saved memories. Meta Gunu memories belong to this application and can be reviewed, corrected, deleted, or cleared by the user.
